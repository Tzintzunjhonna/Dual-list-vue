  ...
  <div class="list-box-wrapper">
    <div class="list-box-item">
      ...
      <div class="bulk-action">
        <div class="select-all" @click="selectAllSource">Seleccionar todo</div>
        <div class="deselect-all" @click="deSelectAllSource">Quitar</div>
      </div>
    </div>
    <div class="actions">
    ...
    <div class="list-box-item">
      ...
      <div class="bulk-action">
        <div class="select-all" @click="selectAllDestination">Seleccionar todo</div>
        <div class="deselect-all" @click="deSelectAllDestination">Quitar</div>
      </div>
    </div>
  </div>
</template>
